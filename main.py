...
from screens_transactions import DepositScreen, WithdrawalScreen, TransferScreen
...
from screens_member import StatementScreen, LoanCalculatorScreen, MyProfileScreen
    ...
    def open_drawer(self):
        if self.nav_drawer:
            if self._drawer_content:
                ...
                role = self.current_user_role or 'member'
